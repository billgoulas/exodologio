...
export function ThemeProvider({ children, themePreference = 'auto' }: ThemeProviderProps) {
  const systemScheme = useSystemColorScheme() ?? "light";
  // Resolve theme preference: if 'auto', use system scheme; otherwise use the preference
  const resolvedScheme: ColorScheme = themePreference === 'auto' ? systemScheme : (themePreference as ColorScheme);
